...
{
    /// <inheritdoc />
    public partial class AddFacultyAndSemesterAndBoarderFK : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create temporary boarder registry entries for existing students with TEMP_ boarder numbers
            migrationBuilder.Sql(@"
                INSERT IGNORE INTO boarder_registry (BOARDER_NO, NAME, STATUS, STUDENT_ID)
                SELECT S_BOARDER_NO, S_NAME, 'Assigned', S_ID
                FROM students
                WHERE S_BOARDER_NO LIKE 'TEMP_%';
            ");
